...
* `Docs/development/` contains repo-authored development documentation.
...
* Development docs are synced from `Docs/development` to `homotechsualdocs/docs/haloapi/development` after successful `develop` pushes.
