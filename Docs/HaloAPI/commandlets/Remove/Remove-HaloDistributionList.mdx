---
id: Remove-HaloDistributionList
title: Remove-HaloDistributionList
hide_title: false
...
```powershell
Remove-HaloDistributionList [-DistributionListID] <Int64> [-ProgressAction <ActionPreference>] [-WhatIf]
