---
id: Remove-HaloViewColumn
title: Remove-HaloViewColumn
hide_title: false
...
```powershell
Remove-HaloViewColumn -ViewColumnID <Int64> [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```powershell
Remove-HaloViewColumn -ViewColumn <Object> [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
