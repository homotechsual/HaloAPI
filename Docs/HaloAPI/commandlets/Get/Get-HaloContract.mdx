...
Get-HaloContract [-Paginate] [-PageSize <Int32>] [-PageNo <Int32>] [-Order <String>] [-OrderDesc]
 [-Search <String>] [-Count <Int32>] [-FullObjects] [-ClientID <Int32>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
```powershell
Get-HaloContract -ContractID <Int64> [-includeDetails] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
