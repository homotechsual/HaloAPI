---
id: Get-HaloDistributionList
title: Get-HaloDistributionList
hide_title: false
...
```powershell
Get-HaloDistributionList [-Paginate] [-PageSize <Int32>] [-PageNo <Int32>] [-Order <String>] [-OrderDesc]
 [-Search <String>] [-Count <Int32>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Single

```powershell
Get-HaloDistributionList -DistributionListID <Int64> [-IncludeDetails] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
