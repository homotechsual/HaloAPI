---
id: Get-HaloSoftwareLicence
title: Get-HaloSoftwareLicence
hide_title: false
...
Get-HaloSoftwareLicence [-ClientID <Int64>] [-Count <Int64>] [-Paginate] [-PageSize <Int32>] [-PageNo <Int32>]
 [-Order <String>] [-OrderDesc] [-IncludeInactive] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Single

```powershell
Get-HaloSoftwareLicence -LicenceID <Int64> -ClientID <Int64> [-IncludeDetails]
