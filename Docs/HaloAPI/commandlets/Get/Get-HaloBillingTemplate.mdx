---
id: Get-HaloBillingTemplate
title: Get-HaloBillingTemplate
hide_title: false
...
```powershell
Get-HaloBillingTemplate [-ShowAll] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Single

```powershell
Get-HaloBillingTemplate -TemplateID <Int64> [-IncludeDetails] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
