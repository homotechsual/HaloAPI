---
id: Set-HaloDistributionList
title: Set-HaloDistributionList
hide_title: false
...
```powershell
Set-HaloDistributionList [-DistributionList] <Object[]> [-SkipValidation] [-ProgressAction <ActionPreference>]
