---
id: New-HaloRecurringInvoice
title: New-HaloRecurringInvoice
hide_title: false
...
```powershell
New-HaloRecurringInvoice [-RecurringInvoice] <Object> [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
