...
FunctionsToExport = 'Connect-HaloAPI', 'Get-HaloAction', 'Get-HaloAgent', 
               ...
               'Get-HaloClient', 'Get-HaloContract', 'Get-HaloInvoice', 'Get-HaloItem', 
               'Get-HaloKBArticle', 'Get-HaloLookup', 'Get-HaloOpportunity', 
               'Get-HaloProject', 'Get-HaloPurchaseOrder', 'Get-HaloQuote', 
               'Get-HaloRelease', 'Get-HaloReport', 'Get-HaloSalesOrder', 
               'Get-HaloService', 'Get-HaloSite', 'Get-HaloStatus', 'Get-HaloSupplier', 
               'Get-HaloTeam', 'Get-HaloTemplate', 'Get-HaloTicket', 
               'Get-HaloTicketType', 'Get-HaloTimesheet', 'Get-HaloUser', 
               'New-HaloAction', 'New-HaloAgent', 'New-HaloAppointment', 
               'New-HaloAsset', 'New-HaloAttachment', 'New-HaloClient', 
               'New-HaloContract', 'New-HaloInvoice', 'New-HaloItem', 
               'New-HaloKBArticle', 'New-HaloOpportunity', 'New-HaloProject', 
               'New-HaloQuote', 'New-HaloReport', 'New-HaloSite', 'New-HaloStatus', 
               'New-HaloSupplier', 'New-HaloTeam', 'New-HaloTicket', 
               'New-HaloTicketType', 'New-HaloUser', 'Set-HaloAction', 'Set-HaloAgent', 
               'Set-HaloAppointment', 'Set-HaloAsset', 'Set-HaloAttachment', 
               'Set-HaloClient', 'Set-HaloContract', 'Set-HaloInvoice', 'Set-HaloItem', 
               'Set-HaloKBArticle', 'Set-HaloOpportunity', 'Set-HaloProject', 
               'Set-HaloQuote', 'Set-HaloReport', 'Set-HaloSite', 'Set-HaloStatus', 
               'Set-HaloSupplier', 'Set-HaloTeam', 'Set-HaloTicket', 
               'Set-HaloTicketType', 'Set-HaloUser'
