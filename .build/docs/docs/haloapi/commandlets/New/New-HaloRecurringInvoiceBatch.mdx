---
id: New-HaloRecurringInvoiceBatch
title: New-HaloRecurringInvoiceBatch
hide_title: false
...
```powershell
New-HaloRecurringInvoiceBatch [-RecurringInvoices] <Object[]> [[-BatchSize] <Int32>] [[-BatchWait] <Int32>]
