...
Get-HaloTeam [-Type <String>] [-IncludeAgentsForTeams <String>] [-MemberOnly] [-ShowCounts] [-Domain <String>]
 [-ViewID <Int32>] [-IncludeEnabled] [-IncludeDisabled] [-DepartmentID <Int32>]
...
```powershell
Get-HaloTeam -TeamID <Int64> [-IncludeDetails] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
