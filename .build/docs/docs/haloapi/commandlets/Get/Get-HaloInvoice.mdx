...
Get-HaloInvoice [-Count <Int32>] [-Search <String>] [-Paginate] [-PageSize <Int32>] [-PageNo <Int32>]
 ...
 [-ClientID <Int32>] [-SiteID <Int32>] [-UserID <Int32>] [-PostedOnly] [-NotPostedOnly]
 [-PaymentStatuses <String>] [-PaymentStatusIds <Int64[]>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
```powershell
Get-HaloInvoice -InvoiceID <Int64> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
Provide a string separated by HTML encoded commas.
