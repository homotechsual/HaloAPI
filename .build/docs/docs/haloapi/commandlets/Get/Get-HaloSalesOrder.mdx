---
id: Get-HaloSalesOrder
title: Get-HaloSalesOrder
hide_title: false
...
Get-HaloSalesOrder [-Count <Int64>] [-Search <String>] [-Paginate] [-PageSize <Int32>] [-PageNo <Int32>]
 ...
 [-ClientID <Int64>] [-SiteID <Int64>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Single

```powershell
Get-HaloSalesOrder -SalesOrderID <Int64> [-IncludeDetails] [-IncludeBillingInfo]
