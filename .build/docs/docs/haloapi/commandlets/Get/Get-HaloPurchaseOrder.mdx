---
id: Get-HaloPurchaseOrder
title: Get-HaloPurchaseOrder
hide_title: false
...
Get-HaloPurchaseOrder [-Count <Int64>] [-Search <String>] [-Paginate] [-PageSize <Int32>] [-PageNo <Int32>]
 ...
 [-SiteID <Int64>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Single

```powershell
Get-HaloPurchaseOrder -PurchaseOrderID <Int64> [-IncludeDetails] [-IncludeBillingInfo]
