...
Get-HaloProject [-Paginate] [-PageSize <Int32>] [-PageNo <Int32>] [-Order <String>] [-OrderDesc]
 ...
 [-IncludeAppointmentID <String>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Single

```powershell
Get-HaloProject -ProjectID <Int64> [-TicketIDOnly] [-IncludeDetails] [-IncludeLastAction]
