---
id: Remove-HaloAppointment
title: Remove-HaloAppointment
hide_title: false
...
```powershell
Remove-HaloAppointment -AppointmentID <Int64> [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```powershell
Remove-HaloAppointment -Appointment <Object> [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
