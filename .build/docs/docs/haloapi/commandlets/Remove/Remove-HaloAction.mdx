---
id: Remove-HaloAction
title: Remove-HaloAction
hide_title: false
...
```powershell
Remove-HaloAction -ActionID <Int64> -TicketID <Int64> [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```powershell
Remove-HaloAction -Action <Object> [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
