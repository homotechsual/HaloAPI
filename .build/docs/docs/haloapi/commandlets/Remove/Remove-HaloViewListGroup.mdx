---
id: Remove-HaloViewListGroup
title: Remove-HaloViewListGroup
hide_title: false
...
```powershell
Remove-HaloViewListGroup -ViewListGroupID <Int64> [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```powershell
Remove-HaloViewListGroup -ViewListGroup <Object> [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
