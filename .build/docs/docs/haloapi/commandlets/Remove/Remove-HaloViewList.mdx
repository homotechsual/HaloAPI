---
id: Remove-HaloViewList
title: Remove-HaloViewList
hide_title: false
...
```powershell
Remove-HaloViewList -ViewListID <Int64> [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```powershell
Remove-HaloViewList -ViewList <Object> [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
